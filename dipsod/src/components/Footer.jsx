  ...
  const searchData = [
    {
      ...
      path: "/",
      keywords: ["главная", "home", "начало"]
    },
    {
      title: "Услуги",
      description: "Наши юридические услуги",
      path: "/service",
      keywords: ["услуги", "services", "помощь", "помогать"]
    },
    {
      title: "Команда",
      description: "Наши юристы и специалисты",
      path: "/team",
      keywords: ["команда", "юристы", "специалисты"]
    },
    {
      title: "О нас",
      description: "Информация о нашей компании",
      path: "/aboutUs",
      keywords: ["о нас", "about", "компания"]
    },
    {
      title: "Контакты",
      description: "Как с нами связаться",
      path: "/contact",
      keywords: ["контакты", "contacts", "связь"]
    },
    {
      title: "Вопросы",
      description: "Задайть вопрос",
      path: "/questens",
      keywords: ["вопрос", "questions", "помощь", "помогать"]
    }
  ];
